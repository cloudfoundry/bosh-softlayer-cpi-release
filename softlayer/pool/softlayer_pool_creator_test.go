...
import (
	...
	fakeslpoolclient "github.com/cloudfoundry/bosh-softlayer-cpi/softlayer/pool/client/vm/fakes"
...
var _ = Describe("SoftLayer_Pool_Creator", func() {
	var (
		softLayerClient *fakeslclient.FakeSoftLayerClient
		sshClient       *fakesutil.FakeSshClient
		softlayerPoolClient *fakeslpoolclient.FakeSoftLayerPoolClient
