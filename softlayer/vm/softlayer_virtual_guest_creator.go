...
func (c *softLayerVirtualGuestCreator) Create(agentID string, stemcell bslcstem.Stemcell, cloudProps VMCloudProperties, networks Networks, env Environment) (VM, error) {
	for _, network := range networks {
		...
		case "manual":
			return softLayerVirtualGuest{}, bosherr.Error("Support manual netowrk soon...")
		case "vip":
			return softLayerVirtualGuest{}, bosherr.Error("SoftLayer Not Support VIP netowrk")
		default:
			return softLayerVirtualGuest{}, bosherr.Errorf("Softlayer Not Support This Kind Of Network: %s", network.Type)
		}
	}
}
