...
pushd bosh-cpi-release
  ...
  cpi_release_filename="bosh-softlayer-cpi"
  cpi_release_name="bosh-softlayer-legacy-cpi"
  tarball_name="dev_releases/${cpi_release_filename}/${cpi_release_name}-${semver}.tgz"
  mkdir -p "dev_releases/${cpi_release_filename}/"
