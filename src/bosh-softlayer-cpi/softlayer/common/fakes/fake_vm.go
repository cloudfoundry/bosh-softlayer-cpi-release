...
type FakeVM struct {
	...
	ConfigureNetworksSettingsStub        func(common.Networks) error
	configureNetworksSettingsMutex       sync.RWMutex
	configureNetworksSettingsArgsForCall []struct {
		arg1 common.Networks
	}
	configureNetworksSettingsReturns struct {
		result1 error
	}
	configureNetworksSettingsReturnsOnCall map[int]struct {
		result1 error
	}
	ConfigureNetworksStub        func(common.Networks) (common.Networks, error)
	configureNetworksMutex       sync.RWMutex
	configureNetworksArgsForCall []struct {
		arg1 common.Networks
	}
	configureNetworksReturns struct {
		result1 common.Networks
		result2 error
	}
...
func (fake *FakeVM) ConfigureNetworksSettings(arg1 common.Networks) error {
	fake.configureNetworksSettingsMutex.Lock()
	ret, specificReturn := fake.configureNetworksSettingsReturnsOnCall[len(fake.configureNetworksSettingsArgsForCall)]
	fake.configureNetworksSettingsArgsForCall = append(fake.configureNetworksSettingsArgsForCall, struct {
		arg1 common.Networks
	}{arg1})
	fake.recordInvocation("ConfigureNetworksSettings", []interface{}{arg1})
	fake.configureNetworksSettingsMutex.Unlock()
	if fake.ConfigureNetworksSettingsStub != nil {
		return fake.ConfigureNetworksSettingsStub(arg1)
	}
	if specificReturn {
		return ret.result1
	}
	return fake.configureNetworksSettingsReturns.result1
}

func (fake *FakeVM) ConfigureNetworksSettingsCallCount() int {
	fake.configureNetworksSettingsMutex.RLock()
	defer fake.configureNetworksSettingsMutex.RUnlock()
	return len(fake.configureNetworksSettingsArgsForCall)
}

func (fake *FakeVM) ConfigureNetworksSettingsArgsForCall(i int) common.Networks {
	fake.configureNetworksSettingsMutex.RLock()
	defer fake.configureNetworksSettingsMutex.RUnlock()
	return fake.configureNetworksSettingsArgsForCall[i].arg1
}

func (fake *FakeVM) ConfigureNetworksSettingsReturns(result1 error) {
	fake.ConfigureNetworksSettingsStub = nil
	fake.configureNetworksSettingsReturns = struct {
		result1 error
	}{result1}
}

func (fake *FakeVM) ConfigureNetworksSettingsReturnsOnCall(i int, result1 error) {
	fake.ConfigureNetworksSettingsStub = nil
	if fake.configureNetworksSettingsReturnsOnCall == nil {
		fake.configureNetworksSettingsReturnsOnCall = make(map[int]struct {
			result1 error
		})
	}
	fake.configureNetworksSettingsReturnsOnCall[i] = struct {
		result1 error
	}{result1}
}

func (fake *FakeVM) ConfigureNetworks(arg1 common.Networks) (common.Networks, error) {
...
func (fake *FakeVM) ConfigureNetworksReturns(result1 common.Networks, result2 error) {
...
func (fake *FakeVM) ConfigureNetworksReturnsOnCall(i int, result1 common.Networks, result2 error) {
	fake.ConfigureNetworksStub = nil
